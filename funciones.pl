...
cuantosHay(R,[],C):-!.
cuantosHay(R,[X|Y],C):- C1 is C, R = X, C is C1+1,cuantosHay(R,Y,C).
cuantosHay(R,[X,Y|Z],C):- C1 is C, R = Y,C is C1+1, cuantosHay(R,Z,C).
cuantosHay(R,[X,Y,Z|W],C):- C1 is C, R = Z, C is C1+1,cuantosHay(R,W,C).
